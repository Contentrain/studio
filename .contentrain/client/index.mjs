...
import _authMarketingEn from './data/auth-marketing.en.mjs'
import _starters from './data/starters.mjs'
import _uiStringsEn from './data/ui-strings.en.mjs'
