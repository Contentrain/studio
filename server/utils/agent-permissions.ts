...
const TOOL_ROLES: Record<string, string[]> = {
  ...
  update_media: ['editor', 'admin', 'owner'],
  delete_media: ['editor', 'admin', 'owner'],
  get_media: ['viewer', 'reviewer', 'editor', 'admin', 'owner'],
  update_status: ['editor', 'admin', 'owner'],
  branch_health: ['viewer', 'reviewer', 'editor', 'admin', 'owner'],
  relation_expand: ['viewer', 'reviewer', 'editor', 'admin', 'owner'],
  vocabulary: ['editor', 'admin', 'owner'],
  add_locale: ['admin', 'owner'],
  delete_model: ['admin', 'owner'],
